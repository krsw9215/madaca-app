...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  if (this.getIosVersion_() >= this.getVersion_(4, 2)) {
    bubbleInner.innerHTML = 'ホーム画面へ追加しましょう！<br />矢印をタップして<b>「ホーム画面に追加」</b>で完了です。';
  } else {
    bubbleInner.innerHTML = 'ホーム画面へ追加しましょう！<br /><b style="font-size:15px">+</b>をタップして<b>「ホーム画面に追加」</b>で完了です。';
  }
